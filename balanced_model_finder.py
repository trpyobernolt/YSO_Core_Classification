...
class Balanced_MLModels:
  ...
  #CHANGE THIS
  savePath = "Data/Balanced Optimized Classifiers/"
  ...
  def splitTestTrain(self, ratio):
    savePath = "Data/Balanced Optimized Classifiers/Sets/"
  ...
  def findBestParams(self):
    ...
    for algo in (self.algorithms.keys()):
        if not(os.path.isfile(f'Data/Balanced Optimized Classifiers/{algo}.joblib')):
